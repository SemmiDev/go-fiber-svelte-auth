...
const components = [
	{
		js: () => Promise.all([import('./index.2b5e336a.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.c8833ad2.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.d7104d12.js'), ]).then(function(x) { return x[0]; })
	}
];
