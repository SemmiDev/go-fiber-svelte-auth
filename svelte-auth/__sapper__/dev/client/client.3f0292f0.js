...
const components = [
	{
		js: () => Promise.all([import('./index.49756de2.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.85ddc883.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.63a31c8e.js'), ]).then(function(x) { return x[0]; })
	}
];
