...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 43, 12, 1226);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 42, 10, 1192);
			attr_dev(a1, "class", "nav-link");
			attr_dev(a1, "href", "/register");
			add_location(a1, file$2, 46, 12, 1330);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 45, 10, 1296);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "href", "#");
			add_location(a, file$2, 39, 12, 1092);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 37, 10, 1000);
		},
		m: function mount(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file$2, 31, 6, 810);
			...
			add_location(button, file$2, 22, 4, 558);
			attr_dev(ul, "class", "navbar-nav ml-auto");
			add_location(ul, file$2, 35, 6, 939);
			attr_dev(div0, "class", "collapse navbar-collapse");
			attr_dev(div0, "id", "navbarSupportedContent");
			add_location(div0, file$2, 34, 4, 866);
...
const components = [
	{
		js: () => Promise.all([import('./index.c42bc9d1.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.88002df1.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.6b4015d1.js'), ]).then(function(x) { return x[0]; })
	}
];
