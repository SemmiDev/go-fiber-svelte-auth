...
const components = [
	{
		js: () => Promise.all([import('./index.eb0151ac.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.99c7ffec.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.c5abb6aa.js'), ]).then(function(x) { return x[0]; })
	}
];
