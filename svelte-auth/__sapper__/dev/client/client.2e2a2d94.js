...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 31, 12, 918);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 30, 10, 884);
			attr_dev(a1, "class", "nav-link");
			attr_dev(a1, "href", "/register");
			add_location(a1, file$2, 34, 12, 1022);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 33, 10, 988);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "href", "#");
			add_location(a, file$2, 27, 12, 784);
...
const components = [
	{
		js: () => Promise.all([import('./index.fba821d0.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.be47718b.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.d1695869.js'), ]).then(function(x) { return x[0]; })
	}
];
