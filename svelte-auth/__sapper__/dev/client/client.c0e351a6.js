...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 30, 12, 860);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 29, 10, 826);
			attr_dev(a1, "class", "nav-link");
			attr_dev(a1, "href", "/register");
			add_location(a1, file$2, 33, 12, 964);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 32, 10, 930);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "href", "#");
			add_location(a, file$2, 26, 12, 726);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 25, 10, 692);
		},
		m: function mount(target, anchor) {
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "href", "/");
			add_location(a, file$2, 21, 4, 512);
			attr_dev(ul, "class", "navbar-nav ml-auto");
			add_location(ul, file$2, 23, 6, 631);
			attr_dev(div0, "class", "collapse navbar-collapse");
			attr_dev(div0, "id", "navbarSupportedContent");
			add_location(div0, file$2, 22, 4, 558);
			attr_dev(div1, "class", "container");
			add_location(div1, file$2, 20, 2, 484);
			attr_dev(nav, "class", "navbar navbar-expand-lg navbar-light navbar-laravel");
			add_location(nav, file$2, 19, 0, 416);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.ab95f1d9.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.b588afbf.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.0791b905.js'), ]).then(function(x) { return x[0]; })
	}
];
