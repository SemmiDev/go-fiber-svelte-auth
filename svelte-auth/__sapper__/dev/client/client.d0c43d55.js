...
const components = [
	{
		js: () => Promise.all([import('./index.4f8aebe5.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.a4de8456.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.10292887.js'), ]).then(function(x) { return x[0]; })
	}
];
