import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, h as goto, j as element, t as text, k as space, l as claim_element, m as children, f as claim_text, c as detach_dev, p as claim_space, q as attr_dev, r as add_location, b as insert_dev, u as append_dev, w as set_input_value, x as listen_dev, y as prevent_default, n as noop, z as run_all } from './client.60fe7b59.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h1_nodes, "Please Sign");
		...
		h: function hydrate() {
			...
			add_location(input0, file, 24, 2, 495);
			attr_dev(input1, "type", "password");
			attr_dev(input1, "class", "form-control");
			attr_dev(input1, "placeholder", "Password");
			input1.required = true;
			add_location(input1, file, 32, 2, 612);
			attr_dev(button, "class", "w-100 btn btn-lg btn-success");
			attr_dev(button, "type", "submit");
			add_location(button, file, 40, 2, 738);
