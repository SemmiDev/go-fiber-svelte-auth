...
const components = [
	{
		js: () => Promise.all([import('./index.dda9a072.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.39284eb5.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.09d92a69.js'), ]).then(function(x) { return x[0]; })
	}
];
