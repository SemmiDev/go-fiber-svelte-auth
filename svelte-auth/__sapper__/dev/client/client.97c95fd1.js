...
const components = [
	{
		js: () => Promise.all([import('./index.961ae058.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.f4f09079.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.59fcb815.js'), ]).then(function(x) { return x[0]; })
	}
];
