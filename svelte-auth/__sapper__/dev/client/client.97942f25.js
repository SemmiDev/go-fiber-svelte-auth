...
const components = [
	{
		js: () => Promise.all([import('./index.6e6edfa8.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.5ea11d16.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.32f7eb64.js'), ]).then(function(x) { return x[0]; })
	}
];
