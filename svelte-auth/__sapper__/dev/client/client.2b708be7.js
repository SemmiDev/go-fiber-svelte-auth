...
const components = [
	{
		js: () => Promise.all([import('./index.4c9551b8.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.e18b8bf1.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.12631c22.js'), ]).then(function(x) { return x[0]; })
	}
];
